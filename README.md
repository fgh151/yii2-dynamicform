...
This extension is forked from [yii2-dynamicform](https://github.com/wbraganca/yii2-dynamicform) with actual library and php version support.
...
```
php composer.phar require --prefer-dist fgh151/yii2-dynamicform "*"
```

or add

```
"fgh151/yii2-dynamicform": "*"
```
...
use fgh151\dynamicform\DynamicFormWidget;
?>
